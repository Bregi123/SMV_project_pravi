        ...
        if (empty($row))
         {
            ...
            if ( $_POST['password']!="")
            {
                ...
                {
                    echo "juhu9";
                    $sql =  "INSERT INTO login ( firstname, surname , user_type, username, mypassword ,email, professor ) VALUES ('" . $_POST['name'] . "', '" . $_POST['surname'] . "', 'Student', '" . $_POST['username'] . "', '" . $_POST['password'] . "', '" . $_POST['email'] . "',false)";
                    echo $sql;
